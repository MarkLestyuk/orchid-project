...
<div>
  ...
  <div>
    ДР
    <input style="margin: 10px;" type="date" name="birthday" id="birthday">
  </div>
  <div>
    город
    <input style="margin: 10px;" type="text" name="city" id="city">
  </div>

  <div>
  phone_number
    <input style="margin: 10px;" type="text" name="phone_number" id="phone_number">
  </div>
  Email
